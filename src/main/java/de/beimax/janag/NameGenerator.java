...
public class NameGenerator {
     ...
     */
    private HashMap<String, JaNaGList> languages = null;

    private HashMap<String, HashMap<String, JaNaGWeightedList>> namePatterns = null;

    /**
     * @param languageFile filename of language file
     * @param semanticsFile filename of semantics file Constructor
     */
     ...
     * @param lang locale entry, e.g. "de", "nl", ... Constructor
     */
     ...
     * @param namePatterns
     */
    private NameGenerator(HashMap<String, JaNaGList> languages,
            HashMap<String, HashMap<String, JaNaGWeightedList>> namePatterns) {
     ...
     * name patterns (you must only read these, not write anything to them!!!)
     */
    ...
    /**
     * @param semanticsFile filename of semantics file Reads the semantic file
     * and parses it into the semantic structure
     */
    public void readSemantics(String semanticsFile) {
        String line;
        HashMap<String, JaNaGWeightedList> pattern = null;
    ...
    /**
     * @param languageFile filename of language file Reads the language file and
     * parses it into the linguistic structure
     */
    ...
    /**
     * @param pattern name of pattern (localized)
     * @param gender name of gender in that pattern (localized)
    ...
    private String[] getGenders(String pattern, int langId) {
        ...
        HashMap<String, JaNaGWeightedList> genderList = namePatterns
    ...
    private String translateLocalizedGenderName(String internationalPattern,
        ...
        // get pattern
        HashMap<String, JaNaGWeightedList> pattern = namePatterns
