/**
 * $Id: NamegenCML.java 14 2010-08-11 09:29:41Z ronix $
 *
...
public class NamegenCML {
    ...
    /**
     * @return number of pattern selected by user Menu 1 - select pattern
     */
    ...
    /**
     * @param pattern name of pattern to select from Menu 2 - select gender
     */
     ...
     * @param options private command line parser
     */
    private static void _parseCommandLine(String command, String lang, String languagetxt, String semanticstxt, String[] options) {
        ...
        if (command.equals("c")) {
            ...
            try {
                ...
                try (Socket so = new Socket(options[3], Integer.parseInt(options[4]))) {
                    //input stream from server
        ...
        if (command.equals("s")) {
            ...
            for (String list1 : list) {
                ...
                String[] genders = ng.getGenders(list1);
