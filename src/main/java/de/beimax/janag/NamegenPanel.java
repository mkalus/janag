...
public class NamegenPanel extends Container implements ActionListener,
    ...
    public void init() {
        ...
        for (String adder1 : adder) {
            chCount.addItem(adder1);
        }
        this.add(chCount);
    ...
    public void itemStateChanged(ItemEvent ie) {
        if (ie.getSource() == chPattern) { // changed pattern
            ...
            if (strPattern == null ? chPattern.getSelectedItem() == null : strPattern.equals(chPattern.getSelectedItem())) {
                return;
            }
